...
conditions:
  ...
  holds:
    targets:
      ...
      - second.bearing-relation
      - second.coupling
    read: "[[Relational Participation Field]], [[Bearing Relation]], and [[Coupling]]. Bearing must be traceable across coupling before relational conditions can be named as a subdomain."
  pairs:
    targets: []
  ...
  nests:
    targets: []
    read: "within Relational Participation Field as the branch of notes where bearing becomes readable as carried relational condition."
  reads:
    targets: []
    read: "Bearing relations become readable where downstream terms evaluate how bearing relation is carried, constrained, repaired, maintained, or reciprocally held."
  carries:
    targets: []
