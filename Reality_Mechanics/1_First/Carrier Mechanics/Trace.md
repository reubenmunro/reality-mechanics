...
conditions:
  ...
  holds: "[[Hold]] and [[Connection]]. Connection must remain held for a backward path through it to be available — Hold does not finish before Trace begins; Trace is held support becoming available backward."
