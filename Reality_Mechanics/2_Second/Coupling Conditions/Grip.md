...
conditions:
  ...
  holds: "[[Coupled Contact]], [[Friction]], and [[Compatibility]]."
  pairs: "Asymmetry carries downward — into [[Traction]]"
  traces:
    - "[[Coupled Contact]]"
    - "[[Contact]]"
    - "[[Friction]]"
    - "[[Compatibility]]"
    - "[[Resistance]]"
  nests: "inside friction as useful coupled contact resistance that supports carrying."
  reads: "where coupled contact resists enough to hold carrying without simply blocking it."
  carries:
    - "[[Traction]]"
