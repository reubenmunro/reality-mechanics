...
conditions:
  ...
  holds: "[[Compatibility]], [[Threshold]], and [[Carrying]]."
  pairs: "[[Overload]]. Capacity names supportable carrying; Overload names load exceeding that supportable capacity."
  traces:
    - "[[Compatibility]]"
    - "[[Threshold]]"
    - "[[Carrying]]"
    - "[[Load]]"
  nests: "as a carrying condition and passage check. It names supportable carrying before overload, failure, shift, or re-resolution."
