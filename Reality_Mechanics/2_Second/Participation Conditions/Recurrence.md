...
conditions:
  ...
  holds: "[[Occur]], [[Participation]], and [[Traversal]]."
  pairs: "Asymmetry carries downward — lateral pair appears in what it carries: [[Coherence]] ↔ [[Incoherence]]"
  traces:
    - "[[Occur]]"
    - "[[Participation]]"
    - "[[Traversal]]"
  nests: "where participation occurs again and remains recognisable across instances."
  reads: "where participation can be read as occurring again — where what takes part now can be identified as the same condition that took part before."
  carries:
    - "[[Pattern]]"
    - "[[Count]]"
    - "[[Coherence]]"
...
Asymmetry carries downward. Recurrence is a singular condition — participation occurring again across traversal. The lateral asymmetry appears in what recurrence carries: [[Coherence]] ↔ [[Incoherence]].
...
Recurrence nests where participation occurs again and remains recognisable across instances.
