...
- Availability is held by Boundary.
- Availability names the condition through which a located distinction can present.
- Availability does not yet require trace, holding, recognition, resolution, or allowance.
- Availability names the condition under which distinction can become present enough to enter later operations.
- Availability is a passage condition as well as a first-order root condition.
...
- Availability is directly held by Boundary and pairs with Boundary: boundary locates distinction; availability names the condition through which that located distinction can present.
- Availability directly carries Strain, Allow, Not, Attend, Notice, Guard, Intake, Delayed Availability, Caring, Sensing, and Resolution Polarity.
- Availability does not directly carry Presence or Participation in the current structure.
...
- Whether Availability's generated mechanic should be named presentability, enterability, or passage condition.
- Whether Presence should be read as local availability without requiring an explicit structural dependency on Availability.
- Whether Participation inherits Availability ancestrally or only reads availability as one condition among Carrying, Presence, and Bearing Relation.
