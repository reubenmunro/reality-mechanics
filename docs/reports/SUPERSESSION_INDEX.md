...
| Label | Meaning |
|---|---|
| **Current** | Authoritative for its domain today |
| **Superseded** | Replaced by a later report; historical evidence only |
| **Partial** | Still valid in part; see note |
| **Archival** | Point-in-time snapshot |
| **Unresolved** | Gap preserved deliberately |
...
## Partial / mixed authority

| Report | Still valid | Superseded part |
|---|---|---|
| **R-003** Programme Coherence | Diagnosis, naming schism analysis | Phase 0 done (R-004); Phase 1 docs open |
| **R-001** Release Audit | Historical blockers | Pre–five-surface |
| **PROJECT_STATUS.md** (pre-M-001) | Stewardship facts | Surface naming, HEAD, deploy state |
| **CLOUDFLARE_SURFACE_MAP.md** (pre-M-001) | Worker names, D1 id | Routes, 410 message, HEAD |

---

## Negative results (preserve, do not hide)

| Report | Finding |
|---|---|
| D-015B | Derived Ratio ≠ Atlas Ratio |
| D-017B | Ember runtime falsified as primary language |
| P-006 | No Weave term promotion |
| P-013 | Read Engine = module pattern, not new P-003 layer |
...
| Report | Date | Value |
|---|---|---|
| FABLE-REPO-STATE-FINDING-2026-07-06 | 2026-07-06 | Pre-D-025 deploy verification narrative |
| D-013 @ `9550d0f` | 2026-07-05 | Cloudflare orphan worker audit |

---

*Add supersession banners to individual reports at their headers when superseded. Do not rewrite report bodies.*
